...
var (
	ReleaseAttemptConcurrentTotal = prometheus.NewGauge(
		prometheus.GaugeOpts{
			Name: "release_attempt_concurrent_total",
			Help: "Total number of concurrent releases",
		},
	)
	...
	ReleaseAttemptDurationSeconds = prometheus.NewHistogramVec(
		prometheus.HistogramOpts{
			...
			Help:    "Total duration of the release from the moment the PipelineRun was created",
	...
	ReleaseAttemptRunningSeconds = prometheus.NewHistogram(
		prometheus.HistogramOpts{
			...
			Help:    "Time for a release to change its state to running",
